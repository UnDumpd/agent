...
func init() {
	DefaultRegistry.Register("sql_assert", SQLAssertRunner{})
}

type SQLAssertRunner struct{}

func (r SQLAssertRunner) Run(ctx context.Context, checkCtx Context, cfg config.CheckConfig) (models.CheckResult, error) {
	if cfg.ID == "" {
